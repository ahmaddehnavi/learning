<?php $this->load->view('base/header'); ?>
	<div id="container">
		...
		<aside id="sidebar">
			...
			<menu>
				<h2>academy :</h2>
				<li class="icon-notice"><?php echo anchor("academy/notices", "notices<b class='label'>2</b>") ?></li>
				<li class="icon-booklet"><?php echo anchor("academy/booklet", "booklet<b class='label'>1</b>") ?></li>
