...
*    @author Pavel Tzonkov
    ...
    */?>
    ...
    (parseInt($.browser.version.substr(0, 1))
        < 8)
        ) {
...
browser.buildTree = function(root, path) {
    ...
    var html = '
            <div class="folder">
                <a href="kcdir:/' + _.escapeDirs(path) + '">
                    <span class="brace">&nbsp;</span>
                    <span class="folder">' + _.htmlData(root.name) + '</span>
                </a>
            ';
            if (root.dirs) {
...
html += '
    <a href="kcact:mvcbd"' + (!data.writable ? ' class="denied"' : '') + '>' +
...
html += '
    <a href="kcact:mkdir"' + (!data.writable ? ' class="denied"' : '') + '>' +
    this.label("New Subfolder...") + '</a>
';
if (this.access.dirs.rename)
html += '
    <a href="kcact:mvdir"' + (!data.removable ? ' class="denied"' : '') + '>' +
    this.label("Rename...") + '</a>
';
if (this.access.dirs['delete'])
html += '
    <a href="kcact:rmdir"' + (!data.removable ? ' class="denied"' : '') + '>' +
    this.label("Delete") + '</a>
';
html += '</div>
';
