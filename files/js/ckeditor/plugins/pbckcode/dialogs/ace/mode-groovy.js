define("ace/mode/groovy", "require exports module ace/lib/oop ace/mode/javascript ace/tokenizer ace/mode/groovy_highlight_rules".split(" "), function (h, j) {
    var i = h("../lib/oop"), f = h("./javascript").Mode, d = h("../tokenizer").Tokenizer, a = h("./groovy_highlight_rules").GroovyHighlightRules, g = function () {
        f.call(this);
...
define("ace/mode/groovy_highlight_rules", "require exports module ace/lib/oop ace/mode/doc_comment_highlight_rules ace/mode/text_highlight_rules".split(" "), function (h, j) {
    var i = h("../lib/oop"), f = h("./doc_comment_highlight_rules").DocCommentHighlightRules, d = h("./text_highlight_rules").TextHighlightRules, a = function () {
        var a = this.createKeywordMapper({"variable.language": "this", keyword: "assert|with|abstract|continue|for|new|switch|assert|default|goto|package|synchronized|boolean|do|if|private|this|break|double|implements|protected|throw|byte|else|import|public|throws|case|enum|instanceof|return|transient|catch|extends|int|short|try|char|final|interface|static|void|class|finally|long|strictfp|volatile|def|float|native|super|while",
            ...
            "constant.language": "null|Infinity|NaN|undefined"}, "identifier");
        this.$rules = {start: [
            {token: "comment", regex: "\\/\\/.*$"},
            f.getStartRule("doc-start"),
