define("ace/mode/scss", "require exports module ace/lib/oop ace/mode/text ace/tokenizer ace/mode/scss_highlight_rules ace/mode/matching_brace_outdent ace/mode/folding/cstyle".split(" "), function (e, i) {
    var h = e("../lib/oop"), b = e("./text").Mode, a = e("../tokenizer").Tokenizer, d = e("./scss_highlight_rules").ScssHighlightRules, f = e("./matching_brace_outdent").MatchingBraceOutdent, c = e("./folding/cstyle").FoldMode, j = function () {
    ...
    h.inherits(j, b);
    (function () {
        this.getNextLineIndent = function (a, f, b) {
            var c = this.$getIndent(f), a = this.$tokenizer.getLineTokens(f, a).tokens;
            return a.length && a[a.length - 1].type == "comment" ? c : (f.match(/^.*\{\s*$/) && (c = c + b), c)
        };
...
define("ace/mode/scss_highlight_rules", "require exports module ace/lib/oop ace/lib/lang ace/mode/text_highlight_rules".split(" "), function (e, i) {
    var h = e("../lib/oop"), b = e("../lib/lang"), a = e("./text_highlight_rules").TextHighlightRules, d = function () {
        var a = b.arrayToMap(function () {
            for (var a = ["-webkit-", "-moz-", "-o-", "-ms-", "-svg-", "-pie-", "-khtml-"], c = ["appearance", "background-clip", "background-inline-policy", "background-origin", "background-size", "binding", "border-bottom-colors", "border-left-colors", "border-right-colors",
                ...
                "user-focus", "user-input", "user-modify", "user-select", "window-shadow", "border-radius"], f = [], b = 0, d = a.length; b < d; b++)Array.prototype.push.apply(f, (a[b] + c.join("|" + a[b])).split("|"));
            return Array.prototype.push.apply(f, c), Array.prototype.push.apply(f, ["azimuth", "background-attachment", "background-color", "background-image", "background-position", "background-repeat", "background", "border-bottom-color", "border-bottom-style", "border-bottom-width", "border-bottom", "border-collapse", "border-color", "border-left-color",
            ...
            "w-resize", "wait", "whitespace", "zero"]), e = b.arrayToMap(["aqua", "black", "blue", "fuchsia", "gray", "green", "lime", "maroon", "navy", "olive", "orange", "purple", "red", "silver", "teal", "white", "yellow"]), g = b.arrayToMap(["@mixin", "@extend", "@include", "@import", "@media", "@debug", "@warn", "@if", "@for", "@each", "@while", "@else", "@font-face", "@-webkit-keyframes", "if", "and", "!default", "module", "def", "end", "declare"]), h = b.arrayToMap(["a", "abbr", "acronym", "address", "applet", "area", "article", "aside", "audio", "b", "base",
        ...
        this.$rules = {start: [
            ...
            {token: function (b) {
                return a.hasOwnProperty(b.toLowerCase()) ? "support.type" :
                    g.hasOwnProperty(b) ? "keyword" : d.hasOwnProperty(b) ? "constant.language" : c.hasOwnProperty(b) ? "support.function" : e.hasOwnProperty(b.toLowerCase()) ? "support.constant.color" : h.hasOwnProperty(b.toLowerCase()) ? "variable.language" : "text"
            }, regex: "\\-?[@a-z_][@a-z0-9_\\-]*"},
    ...
    h.inherits(d, a);
    i.ScssHighlightRules = d
});
define("ace/mode/matching_brace_outdent", ["require", "exports", "module", "ace/range"], function (e, i) {
    var h = e("../range").Range, b = function () {
    };
    (function () {
    ...
    i.MatchingBraceOutdent = b
});
define("ace/mode/folding/cstyle", "require exports module ace/lib/oop ace/range ace/mode/folding/fold_mode".split(" "), function (e, i) {
    var h = e("../../lib/oop"), b = e("../../range").Range, a = e("./fold_mode").FoldMode, d = i.FoldMode = function () {
    };
    h.inherits(d, a);
    (function () {
        ...
        this.getFoldWidgetRange = function (a, c, d) {
            ...
            if (g) {
                ...
                if (g[1])return this.openingBracketBlock(a,
                    g[1], d, c);
                a = a.getCommentFoldRange(d, c + g[0].length);
                return a.end.column = a.end.column - 2, a
            }
            if (c === "markbeginend")if (g = e.match(this.foldingStopMarker)) {
                ...
                d = {row: d, column: c};
                if (a = a.$findOpeningBracket(g[1], d))return a.column++, d.column--, b.fromPoints(a, d)
            }
        }
    }).call(d.prototype)
});
define("ace/mode/folding/fold_mode", ["require", "exports", "module", "ace/range"], function (e, i) {
    var h = e("../../range").Range;
    (function () {
        ...
        this.indentationBlock = function (b, a, d) {
            var f = /\S/, c = b.getLine(a), e = c.search(f);
            if (-1 != e) {
                for (var d =
                    d || c.length, i = b.getLength(), g = c = a; ++a < i;) {
                    var k = b.getLine(a).search(f);
                    if (-1 != k) {
                        if (k <= e)break;
                        g = a
                    }
                }
                if (g > c)return b = b.getLine(g).length, new h(c, d, g, b)
            }
        };
        this.openingBracketBlock = function (b, a, d, e, c) {
            d = {row: d, column: e + 1};
            if (a = b.$findClosingBracket(a, d, c))return c = b.foldWidgets[a.row], null == c && (c = this.getFoldWidget(b, a.row)), "start" == c && a.row > d.row && (a.row--, a.column = b.getLine(a.row).length), h.fromPoints(d, a)
        }
