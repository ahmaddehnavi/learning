define("ace/mode/java", "require exports module ace/lib/oop ace/mode/javascript ace/tokenizer ace/mode/java_highlight_rules".split(" "), function (h, j) {
    var i = h("../lib/oop"), f = h("./javascript").Mode, d = h("../tokenizer").Tokenizer, a = h("./java_highlight_rules").JavaHighlightRules, g = function () {
        f.call(this);
...
define("ace/mode/java_highlight_rules", "require exports module ace/lib/oop ace/mode/doc_comment_highlight_rules ace/mode/text_highlight_rules".split(" "), function (h, j) {
