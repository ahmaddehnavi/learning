define("ace/mode/less", "require exports module ace/lib/oop ace/mode/text ace/tokenizer ace/mode/less_highlight_rules ace/mode/matching_brace_outdent ace/mode/folding/cstyle".split(" "), function (e, i) {
    var h = e("../lib/oop"), b = e("./text").Mode, a = e("../tokenizer").Tokenizer, d = e("./less_highlight_rules").LessHighlightRules, f = e("./matching_brace_outdent").MatchingBraceOutdent, c = e("./folding/cstyle").FoldMode, j = function () {
...
define("ace/mode/less_highlight_rules", "require exports module ace/lib/oop ace/lib/lang ace/mode/text_highlight_rules".split(" "), function (e, i) {
    var h = e("../lib/oop"), b = e("../lib/lang"), a = e("./text_highlight_rules").TextHighlightRules, d = function () {
        ...
        this.$rules = {start: [
            ...
            {token: function (a) {
                return g.hasOwnProperty(a) ? "keyword" : "variable"
            }, regex: "@[a-z0-9_\\-@]*\\b"},
            {token: function (b) {
                return a.hasOwnProperty(b.toLowerCase()) ? "support.type" : g.hasOwnProperty(b) ? "keyword" : d.hasOwnProperty(b) ? "constant.language" : c.hasOwnProperty(b) ? "support.function" : e.hasOwnProperty(b.toLowerCase()) ? "support.constant.color" :
                    h.hasOwnProperty(b.toLowerCase()) ? "variable.language" : "text"
            }, regex: "\\-?[@a-z_][@a-z0-9_\\-]*"},
